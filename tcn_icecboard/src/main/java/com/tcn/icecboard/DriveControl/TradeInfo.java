...
public class TradeInfo {
	...
	public TradeInfo(int slotNo, int payType,boolean isPaySuccess,String tradeNo,String amount,String generatTime,String txnTime) {
		this.m_slotNo = slotNo;
		this.m_payType = payType;
		this.m_bIsPaySuccess = isPaySuccess;
		this.m_tradeNo = tradeNo;
		this.m_amount = amount;
		this.m_generatTime = generatTime;
		this.m_txnTime = txnTime;
	}

	public TradeInfo(int slotNo, boolean isPaySuccess,String tradeNo,String amount) {
		this.m_slotNo = slotNo;
		this.m_bIsPaySuccess = isPaySuccess;
		this.m_tradeNo = tradeNo;
		this.m_amount = amount;
