...
public class ButtonEditSelectD extends RelativeLayout {
    ...
    private void initView(Context context) {
        ...
        // LayoutInflater.from(context).inflate(R.layout.button_edit_layout, this,
        // true);
    ...
    public void setLayouRatio(float ratioEdit, float ratio) {
        LinearLayout.LayoutParams mLayoutParamsoEdit = (LinearLayout.LayoutParams) btn_edit_edit_select
                .getLayoutParams();
